...
--   chance to die if u catch covid in your country 
...
-- countries with most death cases
...
-- vaccination : 
-- transform 
-- pourcentage of population vaccinated :
